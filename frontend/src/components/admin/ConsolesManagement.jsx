...
export default function ConsolesManagement() {
  ...
  const handleDeleteClick = (consoleId) => {
    ...
    if (console) {
      ...
      if (console.games_count > 0) {
        toastConsoleCannotDelete(console.name, console.games_count);
        return;
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmationModal
        ...
        message="¿Estás seguro de que quieres eliminar esta consola? Esta acción no se puede deshacer."
